...
def g():
    ...
    print(survival)
    titanic_url = "https://raw.githubusercontent.com/featurestoreorg/serverless-ml-course/main/src/01-module/assets/" + survival + ".png"
    ...
    # titanic_fg = fs.get_feature_group(name="titnaic_modal", version=1)
    # df = titanic_fg.read()
    # # print(df["variety"])
    ...
    # monitor_fg = fs.get_or_create_feature_group(name="titnaic_predictions",
    #                                             version=1,
